const CACHE = "briar-crown-v1.7.2.1";
const ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  "./icon-192.png",
  "./icon-512.png",
  "./assets/scenes/production-manifest-v1721.json",
  ...
  "./assets/scenes/willow-trail-v1721.webp",
  "./assets/ui/satchel.png",
  "./assets/ui/world-map-v1721.webp"
];
