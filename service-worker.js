const CACHE = "briar-crown-v1.7.2.3";
const ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./assets/scenes/apothecary-center-v1723.webp",
  "./assets/scenes/apothecary-door-v1722.webp",
  "./assets/scenes/apothecary-east-v1722.webp",
  "./assets/scenes/apothecary-north-v1723.webp",
  ...
  "./assets/scenes/production-manifest-v1723.json"
];
